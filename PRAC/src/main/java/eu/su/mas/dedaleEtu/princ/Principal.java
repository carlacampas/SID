...
public class Principal {
	...
	private static List<AgentController> agentList = new ArrayList <>();// agents's ref
...
//	
		...
		/*// Descomentar para activar agente recolector (recordar añadir entidad en agentExplo).
			...
			//2) Give the name of your agent, MUST be the same as the one given in the entities file.
			agentName="CollectGold";

			//3) If you want to give specific parameters to your agent, add them here
			Object [] entityParametersCollectGold={"My parameters"};
		...
		*/
		...
		/*// Descomentar para activar agente recolector (recordar añadir entidad en agentExplo).
			...
			//2) Give the name of your agent, MUST be the same as the one given in the entities file.
			agentName="CollectGold2";

			//3) If you want to give specific parameters to your agent, add them here
			Object [] entityParametersCollectGold2={"My parameters"};

			//4) Give the class name of your agent to let the system instantiate it
			ag=createNewDedaleAgent(c, agentName, GeneralAgent.class.getName(), entityParametersCollectGold2);//ExploreSoloAgent
			agentList.add(ag);
		*/
			/*********
			 * AGENT General 
...
//
//			//2) Give the name of your agent, MUST be the same as the one given in the entities file.
//			agentName="CollectDiamonds";
//
//			//3) If you want to give specific parameters to your agent, add them here
//			Object [] entityParametersCollectDiamonds={"My parameters"};
//
//			//4) Give the class name of your agent to let the system instantiate it
//			ag=createNewDedaleAgent(c, agentName, GeneralAgent.class.getName(), entityParametersCollectDiamonds);//ExploreSoloAgent
//			agentList.add(ag);
			...
			//2) Give the name of your agent, MUST be the same as the one given in the entities file.
			agentName="GeneralAgentExplore";

			//3) If you want to give specific parameters to your agent, add them here
			Object [] entityParametersGeneralAgentExplore={"My parameters"};
			...
			//2) Give the name of your agent, MUST be the same as the one given in the entities file.
			agentName="GeneralAgentExplore2";

			//3) If you want to give specific parameters to your agent, add them here
			Object [] entityParametersGeneralAgentExplore2={"My parameters"};

			//4) Give the class name of your agent to let the system instantiate it
			ag=createNewDedaleAgent(c, agentName, GeneralAgent.class.getName(), entityParametersGeneralAgentExplore2);//ExploreSoloAgent
			agentList.add(ag);
